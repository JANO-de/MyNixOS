...
in {
  home.packages = [
    ...
    pkgs.foot
    pkgs.fuzzel
    pkgs.grim # Added for screenshots
    pkgs.swaylock # Added for locking
    pkgs.quickshell   # The engine
    pkgs.brightnessctl # For brightness slider
    pkgs.networkmanagerapplet # Optional but helpful
  ];
}
